...
[Script]
http-response ^https:\/\/global(\d*)\.bh3\.com\/query_dispatch\?version=(\d*\.\d*\.\d*)_gf_(android|ios|pc)&t=(\d*) requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Mornwind/PublicProfiles/master/BH3_Region_Selector/bh3_region_list.js
[MITM]
...
```
[rewrite_remote]
https://raw.githubusercontent.com/Mornwind/PublicProfiles/master/BH3_Region_Selector/bh3_region_rewrite_remote.conf, tag=BH3 Region Rewrite, enabled=true
[rewrite_local]
